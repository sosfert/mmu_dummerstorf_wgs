...
gatk VariantRecalibrator \
	...
	--resource TRUTH,known=false,training=true,truth=true,prior=12.0:cohort_biallelicINDELs_best.vcf \
	...
	--output cohort_biallelicINDELs.recal \
	-tranches-file cohort_biallelicINDELs.tranches \
	--rscript-file cohort_biallelicINDELs_plots.R
